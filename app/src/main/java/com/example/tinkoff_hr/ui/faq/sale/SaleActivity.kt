...
class SaleActivity : AppCompatActivity() {
    ...
    private fun init() {
        ...
        stateAdapter.addList(
            listOf(
                State(fotoArray[0], "Российский провайдер цифровых услуг и сервисов.", "Ростелеком"),
                State(fotoArray[1], "Билеты на матчи любимой команды", "ХК Металлург"),
                State(fotoArray[2], "Любимый напиток со скидкой", "Coca-Cola"),
                State(fotoArray[3], "Самый популярный оператор связи и интернет-провайдер России", "Билайн"),
                State(fotoArray[2], "Скидка для тех, кто хочет покупать оптом", "Coca-Cola"),
