...
class WorkersFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        workerAdapter.addList(
            listOf(
                Worker(
                    "mail.ru", "Андрей", "Крыш", "Константинович",
                    photoArray[0].toString(), "Мобильное приложение", 1, "Мобильный разработчик", "", ""
                ),
                Worker(
                    "google.com", "Муллаянов", "Рустам", "Радикович",
                    photoArray[0].toString(), "Мобильное приложение", 2, "Мобильный разработчик", "", ""
                ),
                Worker(
                    "mail.ru", "Андрей", "Крыш", "Константинович",
                    photoArray[0].toString(), "Мобильное приложение", 1, "Мобильный разработчик", "", ""
